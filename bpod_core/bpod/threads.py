...
_SYNTHETIC_EVENT_TYPES: dict[EventID, str] = {
    EventID.START_FSM: 'TrialStart',
    EventID.START_STATE: 'StateStart',
    EventID.END_STATE: 'StateEnd',
    EventID.END_FSM_CYCLES: 'TrialEnd',
    EventID.END_FSM_MICROS: 'TrialEndControl',
}
        ...
        while True:
            ...
            if event_index < 255:
                ...
                if target_state == target_exit:  # state exited without a successor
                    self._append(
                        t_system_ns, t_bpod_us, EventID.END_STATE, state=current_state
                    )
                    event_queue.task_done()
                    continue
                ...
                self._append(
                    t_system_ns, t_bpod_us, EventID.START_STATE, state=current_state
                )
